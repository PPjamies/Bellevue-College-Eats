    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //code is manually entered by user
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(PhoneAuthenticationActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {//launch next activity
//                            Intent intent = new Intent(sContext, Main_Activity.class);
...
//                            startActivity(intent);
    ...
    protected void onStart() {
        super.onStart();
        if(FirebaseAuth.getInstance().getCurrentUser() != null){ //user is already logged in
//            Intent intent = new Intent(PhoneAuthenticationActivity.this, Main_Activity.class);
//            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//            startActivity(intent);
            startMain();
        }
